...
-- =========================================================================
-- Seed: allowlisted admin (requires admin_users from schema.sql)
-- Replace the placeholder with your Google account email, then sign in on
-- the web app so a session cookie exists for the admin panel.
-- =========================================================================

INSERT INTO admin_users (email, role, status)
VALUES ('enter your google id', 'engineering_admin', 'active')
